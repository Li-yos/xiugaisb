...
def generate_singbox_config(domain, uuid_str):
    ...
    while random_http_port == random_socks_port: # 确保两个随机端口不一致
        random_http_port = random.randint(2000, 50000)
...
# ... (install_or_start_modified 和其他核心逻辑函数保持不变) ...
...
# ... (UI 渲染函数部分，render_node_info_page 稍作调整以添加提示) ...
